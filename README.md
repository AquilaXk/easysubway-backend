...
아래는 저장소의 API 계약 파일입니다. 열차 검색 계약은 요청·응답 형식을 담고 있습니다. 실시간·시설 제보 계약은 요청 파라미터·요청 본문과 응답 스키마가 아직 비어 있어 보완 중이며(#37), 경로 탐색은 계약 파일이 아직 없습니다. 이 API들의 요청·응답 형식은 협의로 확인해 주세요.
