CREATE TABLE route_v2_sessions (
	...
	CONSTRAINT chk_route_v2_sessions_token_sha256 CHECK (REGEXP_LIKE(token_sha256, '^[0-9a-f]{64}$')),
...
CREATE TABLE route_v2_nonce_replays (
	...
	expires_at TIMESTAMP WITH TIME ZONE NOT NULL,
	CONSTRAINT chk_route_v2_nonce_sha256 CHECK (REGEXP_LIKE(nonce_sha256, '^[0-9a-f]{64}$'))
);
