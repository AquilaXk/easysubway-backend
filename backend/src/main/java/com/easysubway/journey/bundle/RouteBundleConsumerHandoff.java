...
/** Immutable structural projection. It is not a verified candidate or activation token. */
public record RouteBundleConsumerHandoff(
	...
	String platformServerRouteBundleDigest,
	String handoffSha256) {

	public RouteBundleConsumerHandoff {
		...
		platformServerRouteBundleDigest = Objects.requireNonNull(
			platformServerRouteBundleDigest, "platformServerRouteBundleDigest");
		handoffSha256 = Objects.requireNonNull(handoffSha256, "handoffSha256");
	}
